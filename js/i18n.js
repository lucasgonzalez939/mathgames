    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                'placevalue-perfect': 'Perfect! You built',
                'placevalue-exceeded': 'Oops! You went over',
                'placevalue-exceeded-hint': 'Use the Reset button to try again.',
                'placevalue-too-big': 'That would make the number too big! Target is',
                'placevalue-max-blocks': 'Maximum',
                'placevalue-blocks-reached': 'blocks reached!',
                'placevalue-hint-need-more': 'You need',
                'placevalue-hint-more': 'more',
                'placevalue-hint-hundred-blocks': 'hundred block(s).',
                'placevalue-hint-ten-blocks': 'ten block(s).',
                'placevalue-hint-one-blocks': 'one block(s).',
                'placevalue-hint-perfect': 'Perfect! You\'ve built the target number!',
                'placevalue-hint-breakdown': 'hundreds +',
                'placevalue-hint-breakdown-tens': 'tens +',
                'placevalue-hint-breakdown-ones': 'ones',
            ...
            es: {
                ...
                'placevalue-total': 'Total',
                'placevalue-perfect': '¡Perfecto! Construiste',
                'placevalue-exceeded': '¡Ups! Te pasaste de',
                'placevalue-exceeded-hint': 'Usa el botón Reiniciar para intentarlo de nuevo.',
                'placevalue-too-big': '¡Eso haría el número demasiado grande! El objetivo es',
                'placevalue-max-blocks': 'Máximo de bloques de',
                'placevalue-blocks-reached': 'alcanzado!',
                'placevalue-hint-need-more': 'Necesitas',
                'placevalue-hint-more': 'más',
                'placevalue-hint-hundred-blocks': 'bloque(s) de centena.',
                'placevalue-hint-ten-blocks': 'bloque(s) de decena.',
                'placevalue-hint-one-blocks': 'bloque(s) de unidad.',
                'placevalue-hint-perfect': '¡Perfecto! ¡Has construido el número objetivo!',
                'placevalue-hint-breakdown': 'centenas +',
                'placevalue-hint-breakdown-tens': 'decenas +',
                'placevalue-hint-breakdown-ones': 'unidades',
